            ...
            <section class="section section-divider gray delivery">
                <div class="container">
                    ...
                    <figure class="delivery-banner">
                        <img src="./assets/images/delivery-banner-bg.png" style={{ width: "700", height: "602" }} loading="lazy" alt="clouds"
                            class="w-100" />

                        <img src="./assets/images/delivery-boy.svg" style={{ width: "1000", height: "880" }} loading="lazy" alt="delivery boy"
