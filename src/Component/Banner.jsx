                    ...
                    <ul class="banner-list">
                        ...
                        <li class="banner-item banner-lg">
                            <div class="banner-card">
                                ...
                                <img src="./assets/images/banner-1.jpg" style={{width:"550" , height:"450"}} loading="lazy"
                        ...
                        <li class="banner-item banner-sm">
                            <div class="banner-card">
                                ...
                                <img src="./assets/images/banner-2.jpg" style={{width:"550" , height:"465"}} loading="lazy" alt="Delicious Pizza"
                                    class="banner-img" />
                        ...
                        <li class="banner-item banner-sm">
                            <div class="banner-card">
                                ...
                                <img src="./assets/images/banner-3.jpg" style={{width:"550" , height:"465"}} loading="lazy" alt="American Burgers"
                                    class="banner-img" />
                        ...
                        <li class="banner-item banner-md">
                            <div class="banner-card">
                                ...
                                <img src="./assets/images/banner-4.jpg" style={{width:"550" , height:"220"}} loading="lazy" alt="Tasty Buzzed Pizza"
                                    class="banner-img" />
